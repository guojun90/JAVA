...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"当前 {from} 条 -{to} 条，总计 {total} 条",nav:{first:{iconCls:"pagination-first",handler:function(){
...
var cls=opts.icon?"messager-"+opts.icon:"";
...
opts=$.extend({},$.messager.defaults,{content:"<div class=\"messager-question\"></div>"+"<div>"+opts.msg+"</div>"+"<div style=\"clear:both;\"/>"},opts);
if(!opts.buttons){
opts.buttons=[{text:opts.ok,onClick:function(){
_2b9(dlg,true);
...
opts=$.extend({},$.messager.defaults,{content:"<div class=\"messager-question\"></div>"+"<div>"+opts.msg+"</div>"+"<br/>"+"<div style=\"clear:both;\"/>"+"<div><input class=\"messager-input\" type=\"text\"/></div>"},opts);
if(!opts.buttons){
opts.buttons=[{text:opts.ok,onClick:function(){
